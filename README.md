Relay Speedrun
==============
This is a server-side mod that provides a game play of a multi-player relay speedrun, inspired by
...
move and inspect the world nor spectate the current player.
